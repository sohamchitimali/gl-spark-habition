...
wt ^
new-tab --title "Eureka :8761" -d "%~dp0EurekaServer" cmd /k "mvnw.cmd spring-boot:run" ; ^
new-tab --title "Gateway :8080" -d "%~dp0ApiGateway" cmd /k "timeout /t 10 && mvnw.cmd spring-boot:run" ; ^
new-tab --title "Auth :8081" -d "%~dp0AuthService" cmd /k "timeout /t 15 && mvnw.cmd spring-boot:run" ; ^
new-tab --title "Group :8082" -d "%~dp0GroupService" cmd /k "timeout /t 20 && mvnw.cmd spring-boot:run" ; ^
new-tab --title "Habit :8083" -d "%~dp0HabitService" cmd /k "timeout /t 25 && mvnw.cmd spring-boot:run" ; ^
new-tab --title "Notify :8085" -d "%~dp0NotificationService" cmd /k "timeout /t 30 && mvnw.cmd spring-boot:run"
